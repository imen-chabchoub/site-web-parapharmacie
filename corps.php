        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              ...
              <!--<a id="btnLogin" href="connexion.php">Connexion</a>
              <a id="btnSignUp" href="registre.php">Registre</a>-->
            <form class="d-flex" action="corps.php" method="POST">
                ...
                foreach ($produits as $produit) {
                    ...
                    <a href="produit.php?id=<?php echo $produit['id']; ?>" style="color:black;">
                        ...
                        <div class="box-text text-center">
                            ...
                            <!--<div class="add-to-cart-button" style="margin-top:15px">
                                <a href="?add-to-cart=<?php //echo $produit['id']; ?>" data-quantity="1" class="primary is-small mb-0 button product_type_simple add_to_cart_button ajax_add_to_cart is-outline" data-product_id="<?php echo $produit['id']; ?>" data-product_sku="" aria-label="Ajouter au panier&nbsp;: <?php echo $produit['nom']; ?>" aria-describedby rel="nofollow">Ajouter au panier</a>
                            </div>-->
