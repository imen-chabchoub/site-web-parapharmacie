...
<div class="container-fluid">
  ...
  <tbody>
    ...
    foreach($categories as $c){
        ...
        <td>'.$c['description'].'</td>
        <td>
          <a href="" data-toggle="modal" data-target="#editModal'.$c['id'].'"class="btn btn-success">Modifier</a>
      ...
      <div class="modal-body">
        <form action="ajout.php" method="post">
            <div class="form-group">
                <input type="text" required name="nom" class="form-control" placeholder="nom de categorie...">
